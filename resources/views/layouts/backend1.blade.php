...
<body>
 ...
 <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
            <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
              <i class="nav-main-link-icon si si-user"></i>
              <span class="nav-main-link-name">Programme de mon etablissement</span>
            </a>
            <ul class="nav-main-submenu">
              <li class="nav-main-item">
              
  <a class="nav-main-link{{ request()->is('pages/datatables') ? ' active' : '' }}" href="  {{route('GesEtat.indexEtat',Auth::user()->id) }}">
          <span class="nav-main-link-name">Nos programmes</span>
                </a>
              ...
              <li class="nav-main-item">
                ...
                <a class="nav-main-link{{ request()->is('pages/slick') ? ' active' : '' }}" href="{{ route('re.etablissement') }}">
                  ...
                  <span class="nav-main-link-name">Statisques</span>
                </a>
              </li>
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown d-inline-block ml-2">
            ...
            <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="page-header-user-dropdown">
              ...
              <div class="p-2">
                <a href="{{route('edited.user',Auth::user()->id)}}" class="dropdown-item d-flex align-items-center justify-content-between">Modifier le compte</a>
