...
<div>
  ...
  <a href="{{route('programme')}}" class="btn btn-success mb-2"  style="position:relative;left:80%; ">Voir Tout</a>

  @if($programme->count() == 0) <div class="alert alert-warning pb-5 text-center text-danger">
